...
<div class = "sidebar">
    <h1 style = "position: absolute; top: 200px; left: 550px" style="text-align: center;
    /*color: rgba(43,45,48,0.95);*/
    font-family: 'Courier New';
    color: DarkSlateGray">Пользователь с таким логином уже существует!</h1>
    <a style = "position: absolute; top: 300px; left: 680px" href = "main.jsp">НА ГЛАВНУЮ</a>
    <!--<a style = "position: absolute; top: 300px; left: 680px" href = "admin.jsp">В меню администратора</a> -->
</div>
